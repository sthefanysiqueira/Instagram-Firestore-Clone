...
class RegistrationController: UIViewController {
    ...
    private let plushPhotoButton: UIButton = {
        ...
        button.tintColor = .white // define a imagem como branca
    ...
    @objc func handleShowLogin() {
        navigationController?.popViewController(animated: true) // Animação de arrastar de volta pra página de Login
    }
